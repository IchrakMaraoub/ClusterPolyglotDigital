"""
Django settings for Qualifeed project.
...
SECRET_KEY = env('SECRET_KEY', default='RRtJymOBrQWxSOqxjfAjcrCfZpAQXQfkPoFlKglJ')
...
ROOT_URLCONF = 'qualifeed_app.urls'
...
WSGI_APPLICATION = 'qualifeed_app.wsgi.application'
...
if 'DATABASE_URL' in env:
    ...
    DATABASES = {
        'default': {
            ...
            'NAME': env('DJANGO_DATABASE_NAME', default='qualifeed_app'),
...
LANGUAGE_CODE = 'en-us'
LANGUAGE_COOKIE_NAME = 'qualifeed_app_language'
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'qualifeed.polyglot@gmail.com'
EMAIL_HOST_PASSWORD = 'enxbwsdyubkhoenc'
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_FILTER_BACKENDS': (
        ...
        #'path.to.ImageFieldFilterBackend',
    ),
...
WAGTAIL_SITE_NAME = 'Qualifeed Content'
...
PROJECT_METADATA = {
    'NAME': gettext_lazy('Qualifeed'),
    'URL': 'http://qualifeed.io',
    'DESCRIPTION': gettext_lazy("Quality control application"),
    'IMAGE': 'https://upload.wikimedia.org/wikipedia/commons/2/20/PEO-pegasus_black.svg',
    'KEYWORDS': 'SaaS, django',
    'CONTACT_EMAIL': 'contact@polyglot-digital.com',
}

USE_HTTPS_IN_ABSOLUTE_URLS = False  # set this to True in production to have URLs generated with https instead of http

ADMINS = [('Polyglot Digital', 'contact@polyglot-digital.com')]
...
LOGGING = {
    ...
    'loggers': {
        ...
        'qualifeed_app': {
            'handlers': ['console'],
            'level': env('QUALIFEED_APP_LOG_LEVEL', default='INFO'),
        }
    }
}
